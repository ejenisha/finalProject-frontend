...
const Training = ({role}) => {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        const response = await axios.get('http://localhost:3000/getAllEmployees'); // Fetch employee data
    ...
    const fetchTrainings = async () => {
      try {
        const response = await axios.get('http://localhost:3000/getAllTrainings'); // Fetch training data
  ...
  const handleChange = (e) => {
    ...
    // When Training ID is selected, find and set the corresponding Training name and Trainer name
      ...
      const selectedTraining = trainings.find(training => training.Training_id === value);
      setFormData({
        ...formData,
        Training_id: value,
      ...
      <div className="m-12 w-full max-h-full max-w-7xl bg-white rounded-lg shadow-lg p-10">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-8">
            ...
            <div>
              <label className="block font-semibold  text-[#3411a3] mb-2" htmlFor="emp_id">Employee Id</label>
              <select
                id="emp_id"
                name="emp_id"
            ...
            <div>
              <label className="block font-semibold  text-[#3411a3] mb-2" htmlFor="emp_name">Employee Name</label>
              <input
               type="text"
              id="emp_name"
           name="emp_name"
            ...
            <div>
              <label className="block font-semibold  text-[#3411a3] mb-2" htmlFor="Training_id">Training Id</label>
              <select
                id="Training_id"
                name="Training_id"
            ...
            <div>
              <label className="block font-semibold  text-[#3411a3] mb-2" htmlFor="Training_name">Training Name</label>
              <input
                type="text"
                id="Training_name"
                name="Training_name"
            ...
            <div>
              <label className="block font-semibold text-[#3411a3] mb-2" htmlFor="Trainer_name">Trainer Name</label>
              <input
                type="text"
                id="Trainer_name"
                name="Trainer_name"
            ...
            {/* Other fields */}
            <div>
              <label className="block font-semibold  text-[#3411a3] mb-2" htmlFor="project_scores">Project Scores (out of 100)</label>
              <input
                type="text"
                id="project_scores"
                name="project_scores"
            ...
            <div className="col-span-2">
              <label className="block font-semibold text-[#3411a3] mb-2" htmlFor="comments">Comments</label>
              <textarea
                id="comments"
                name="comments"
          ...
          <div className="mt-8 p-6 border border-gray-300 rounded-lg">
            ...
            <div className="grid grid-cols-3 gap-20 items-center">
              <h3 className="font-semibold text-[#3411a3] text-center">Understanding Requirements (out of 10)</h3>
              <h3 className="font-semibold text-[#3411a3] text-center">Time Management (out of 10)</h3>
              <h3 className="font-semibold text-[#3411a3] text-center">Hackerrank Scores (out of 10)</h3>
            </div>
